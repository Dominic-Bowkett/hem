...
export const hem_version: (a: number) => void;
export const init: () => void;
export const run: (a: number, b: number, c: number) => void;
export const run_with_epw: (a: number, b: number, c: number, d: number, e: number) => void;
